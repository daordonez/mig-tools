...
$ODM_REGION = $__CONF.params.oDMTenantConfiguration.region
$ODM_ORGID = $__CONF.params.oDMTenantConfiguration.organizationId
$ODM_PROJECTID = $__CONF.params.oDMTenantConfiguration.projectId
...
Set-Clipboard -Value ". 'C:\Program Files\WindowsPowerShell\Modules\ODMApi\OdmAPI.Types.ps1'"
